...
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.MailAlreadyExistsException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.NoDataFoundException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.PersonAlreadyExistsException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.PersonNotFoundException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.RoleNotAllowedForCreationException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.RoleNotFoundException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.UserAlreadyExistsException;
import com.pragma.powerup.foodCourt_microservice.adapters.driven.jpa.mysql.exceptions.UserNotFoundException;
...
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.MAIL_ALREADY_EXISTS_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.NO_DATA_FOUND_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.PERSON_ALREADY_EXISTS_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.PERSON_NOT_FOUND_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.RESPONSE_ERROR_MESSAGE_KEY;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.ROLE_NOT_ALLOWED_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.ROLE_NOT_FOUND_MESSAGE;
import static com.pragma.powerup.foodCourt_microservice.configuration.Constants.USER_ALREADY_EXISTS_MESSAGE;
